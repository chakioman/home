...
<body style="padding:0px; margin:0px; font-family:Arial, Verdana;background-color:#fff;">
    ...
    <script>
     ...
     <a href="../member02/container_login.jsp" style ="float: right; right: 10px; top: 10px;">เข้าสู่ระบบสมาชิก</a>
    ...
    <div id="slider1_container" style="position: relative; margin: 0 auto;
        ...
        <!-- Slides Container -->
        <div data-u="slides" style="cursor: move; position: absolute; left: 50px; top: 60px; width: 543px;
            height: 398px; overflow: hidden;">
            <div>
                <img data-u="image" src="pic/product/S_may_1.jpeg" alt="" />
